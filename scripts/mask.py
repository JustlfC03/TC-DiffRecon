...
data_kspace=pickle.load(open('./data/val/img1/file1000017_16.pt','rb'))
# print(data_kspace['fine'].shape)
# sample1=data_kspace['fine'][0,0]
# sample2=data_kspace['fine'][0,1]*1j
...
# print(type(sample2))
#
# k_shift_kspace = np.fft.ifftshift(sample, axes=(-2, -1))
...
# plt.imshow(np.abs(image_shift_kspace), cmap='gray')
plt.imshow(np.abs(data_kspace['img']), cmap='gray')
plt.savefig("a.png")
plt.show()
